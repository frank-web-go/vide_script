    ...
    <el-card class="box-card">
        ...
        <div class="seach-form">
            <el-form :inline="true" style="float: left;">
                <!-- <el-form-item label="ID">
                    <el-input v-model="table.params.id" placeholder="请输入操作用户ID" clearable style="margin-right: 10px"
                        size="small"></el-input>
                </el-form-item> -->
                <el-form-item label="IP">
                    <el-input v-model="table.params.ip" placeholder="请输入IP" clearable style="margin-right: 10px"
                        size="small"></el-input>
                </el-form-item>
                <el-form-item label="类型">
                    <el-input v-model="table.params.operation_type" placeholder="请输入类型" clearable style="margin-right: 10px"
                        size="small"></el-input>
                </el-form-item>
                <!-- <el-form-item label="">
                    <el-date-picker size="small" v-model="select.dataTime" type="daterange" range-separator="至"
        ...
        <div class="table-box" ref="tableBox">
            ...
            <el-table v-loading="loading" ref="multipleTable" :data="table.data" border v-if="tableHeight"
                ...
                <el-table-column prop="operation_desc" label="内容" align="center"></el-table-column>
                <el-table-column prop="operation_type" label="操作类型" align="center"></el-table-column>
                <el-table-column prop="account" label="账号" align="center"></el-table-column>
                <el-table-column prop="ip" label="操作IP" align="center"></el-table-column>
                <el-table-column prop="create_time" width="180" label="操作时间" align="center"
...
import { adminloglist } from "@/api/user";
export default {
    name: "sysLog",
    data() {
        return {
            loading: false,
            select: {
                dataTime: [new Date(new Date().setHours(0, 0, 0, 0)), new Date(new Date().setHours(0, 0, 0, 0))],
            },
            table: {
                params: {
                    page: 1,
    ...
    methods: {
        ...
        getList(page) {
            ...
            let params = {
                ...this.table.params,
                stime: this.$moment(this.$moment(this.select.dataTime[0]).format('YYYY-MM-DD') + ' 00:00:00').valueOf() / 1000,
                etime: this.$moment(this.$moment(this.select.dataTime[1]).format('YYYY-MM-DD') + ' 23:59:59').valueOf() / 1000
            }
            adminloglist(params)
                .then((res) => {
