...
import { pageLan, deletemanyLan } from "@/api/dictionary";
export default {
  components: {
    TagsModal,
  },
  ...
  data() {
    return {
      columns: [
        ...
        { title: "语言", key: 'name', align: 'center' },
        { title: "排序", key: 'sort_index', align: 'center'},
  ...
  methods: {
    ...
    getList() {
      pageLan(this.table.params).then(res => {
        console.log(res);
