            ...
            <div style="padding: 10px">
                <Form :ref="modal.ref" :model="modal.params" :rules="modal.rules" :label-width="110">
                    <Row>
                        ...
                        <Col span="18">
                        <FormItem label="平台账号" prop="platform_account">
                            <Input v-model="modal.params.platform_account"></Input>
                        </FormItem>
                        </Col>
                        <Col span="18">
                        <FormItem label="描述">
                        ...
                        <!-- <Col span="18">
                        <FormItem label="任务绑定数量">
                            <Input v-model.number="modal.params.task_num" type="number"></Input>
                        </FormItem>
                        </Col> -->
                    </Row>
                </Form>
